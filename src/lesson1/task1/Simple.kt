 ...
 * 1 сажень = 3 аршина = 48 вершков, 1 вершок = 4.445 см. 1 ar = 16 ver
 */
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val a: Double = initial * percent / 100.0
    val b: Double = (initial + a) * percent / 100.0
    val c: Double = (initial + a + b) * percent / 100.0
